...
const HeroBanner = () => {
    return (
        <section className="w-full banner h-full relative border rounded-lg overflow-hidden">
            <Image desktopSrc="/assets/banner/desktop.webp" mobileSrc="/assets/banner/mobile.webp" alt="" priority width={1392} height={720} className="top-0 left-0 object-cover w-full h-full z-0" />
