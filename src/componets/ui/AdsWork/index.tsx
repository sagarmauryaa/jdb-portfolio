...
const AdsWork = () => {
    return (
        <section className="grid md:grid-cols-2 lg:grid-cols-5 gap-3 md:gap-6 adsWork" id="ads">
            ...
            <WorkCard img={{ desktop: "/assets/work/ads/desktop/0.webp", mobile: "/assets/work/ads/mobile/0.webp", alt: "" }} name="Caratlane" category="Ads" href="https://www.youtube.com/watch?v=iK2oPfFaIik&ab_channel=Caratlane" grid="col-span-1 row-span-1 lg:row-span-2 aspect-[170/220] lg:aspect-[259/524]" />
            <WorkCard img={{ desktop: "/assets/work/ads/desktop/1.webp", mobile: "/assets/work/ads/mobile/1.webp", alt: "" }} name="Razorpay" category="Ads" href="https://www.youtube.com/watch?app=desktop&fbclid=PAAaY01bwXN2uvyHH_Aa0Fkyawh8sTtzXKQa97GbMwcunNY8zSbcNbXQCotzI&v=cQe5uK3SD1s&feature=youtu.be&ab_channel=Razorpay" grid="aspect-[170/220] lg:aspect-[826/524] col-span-1 lg:col-span-3 row-span-1 lg:row-span-2" />
            <WorkCard img={{ desktop: "/assets/work/ads/desktop/2.webp", mobile: "/assets/work/ads/mobile/2.webp", alt: "" }} name="Caratlane" category="Ads" href="https://www.youtube.com/watch?v=Ppo8T4tKXOY&ab_channel=Caratlane" grid="col-span-1 row-span-1 lg:row-span-2 aspect-[170/220] lg:aspect-[259/524]" />
            <WorkCard img={{ desktop: "/assets/work/ads/desktop/3.webp", mobile: "/assets/work/ads/mobile/3.webp", alt: "" }} name="Pigeon India" category="Ads" href="https://www.youtube.com/watch?v=Cudx5RQnA3I&ab_channel=PigeonIndia" grid="col-span-1 lg:col-span-3 row-span-2 aspect-[170/220] lg:aspect-[826/524]" />
            <WorkCard img={{ desktop: "/assets/work/ads/desktop/4.webp", mobile: "/assets/work/ads/mobile/4.webp", alt: "" }} name="Caratlane" category="Ads" href="https://www.youtube.com/watch?v=2DZRyys1cSs&ab_channel=Caratlane" grid="col-span-1 row-span-1 lg:row-span-2 aspect-[170/220] lg:aspect-[259/524]" /> 
            ...
            <WorkCard img={{ desktop: "/assets/work/ads/desktop/6.webp", mobile: "/assets/work/ads/mobile/6.webp", alt: "" }} name="Goel TMT" category="Ads" href="https://www.youtube.com/watch?v=JfJAvA_Tmqg&ab_channel=GOELTMT" grid="col-span-1 row-span-1 lg:row-span-2 aspect-[170/220] lg:aspect-[259/524]" /> 
