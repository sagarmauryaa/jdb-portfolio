...
const Originals = () => {
    return (
        <section className="grid md:grid-cols-2 lg:grid-cols-5 gap-3 md:gap-6" id="originals">
            ...
            <WorkCard hasBrand={false} img={{ desktop: "/assets/work/originals/desktop/2.png", mobile: "/assets/work/originals/mobile/2.png", alt: "" }} name="Tripolar" category="YouTube" href="https://www.youtube.com/watch?v=7h9w3H93M0o&ab_channel=TripolarTV" grid="col-span-1 row-span-1 lg:row-span-2 aspect-[170/220] lg:aspect-[259/524]" /> 
            <WorkCard hasBrand={false} img={{ desktop: "/assets/work/originals/desktop/3.png", mobile: "/assets/work/originals/mobile/3.png", alt: "" }} name="The Pulse Construct" category="Spotify" href="https://www.youtube.com/watch?v=ByzThabh0t8&ab_channel=pshiftbis" grid="col-span-2 lg:col-span-3 --full-width aspect-[351/222] lg:aspect-[826/250]" /> 
        </section>
    )
}
