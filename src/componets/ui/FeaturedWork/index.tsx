...
const FeaturedWork = () => {
    return (
        <section className="grid md:grid-cols-2 lg:grid-cols-5 gap-3 md:gap-6" id="featured-work">
            ...
            <SonicWorkCard src="/assets/work/sonic-identities/audio/0.mp3" img={{ common: "/assets/work/sonic-identities/0.png", alt: "" }} grid="aspect-[259/250] grid lg:hidden col-span-1" />
            ...
            <SonicWorkCard src="/assets/work/sonic-identities/audio/0.mp3" img={{ common: "/assets/work/sonic-identities/0.png", alt: "" }} grid="aspect-[259/250] lg:block hidden" /> 
        </section>
    )
}
