...
const FeaturedWork = () => {
    return (
        <section className="grid md:grid-cols-2 lg:grid-cols-5 gap-3 md:gap-6" id="featured-work">
            <h2 className="aspect-[259/250] col-span-1 rounded-lg bg-black p-2 lg:p-4 border text-left flex justify-start items-start transition-colors duration-200 bg-primary !text-white w-fit md:w-full"
            >
                ...
                >
                    <span className="inline workHeading">
                        Featured
                        <br />
                        Work
                    </span>
